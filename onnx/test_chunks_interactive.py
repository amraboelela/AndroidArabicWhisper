...
def main():
  """Test model chunk by chunk interactively"""
  ...
  print("="*60)
  print("Testing 1-Second Chunks (Interactive)")
  print("="*60)
  ...
  print("\nPress Enter to see next chunk (or Ctrl+C to quit)...\n")
  ...
  for i in range(num_chunks):
    ...
    print(f"Chunk {i+1}/{num_chunks} ({i}s-{i+1}s): {words_str}")
