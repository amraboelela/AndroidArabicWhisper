#!/usr/bin/env python3
"""
Train encoder-decoder model on ALL segments (001, 002-01, 002-02) - 100 epochs
"""
import json
import torch
...
# Training
# ==============================================================
def train_on_segments(model, segment_files, transcriptions, vocab, num_epochs=100, initial_lr=1e-3, min_lr=1e-6):
...
def main():
    ...
    if os.path.exists(model_path):
        ...
        print("✓ Model loaded successfully! Continuing training on ALL segments.")
    else:
        print("No existing model found. Starting with fresh weights for all segments training.")

    # Train
    print(f"\nStarting training for 10 epochs on all {len(all_segment_files)} segments...\n")
