#!/usr/bin/env python3
"""
Train encoder-decoder model on Al-Baqara first 3 seconds → first 2 words
"""
import json
import torch
...
# Training
# ==============================================================
def train_first_3_seconds(model, segment_files, transcriptions, vocab, num_epochs=5, learning_rate=1e-5):
    ...
    for epoch in range(num_epochs):
        ...
        if avg_loss < best_loss:
            ...
            torch.save({
                ...
                "epoch": epoch
            }, "checkpoint_best_first_3_seconds.pt")
...
def main():
    ...
    print("Training on: Al-Baqara first 3 seconds → first 2 words")
