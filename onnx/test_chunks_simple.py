...
def main():
  """Test model chunk by chunk with simple output"""
  ...
  print(f"\n{'='*60}")
  print(f"Processing {num_chunks} one-second chunks:")
  print(f"{'='*60}\n")
  ...
  for i in range(num_chunks):
    ...
    print(f"Chunk {i+1:2d} ({i:2d}s-{i+1:2d}s): {words_str}")
