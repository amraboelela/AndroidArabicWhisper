#!/usr/bin/env python3
"""
Train encoder-decoder model on Al-Fatiha first second → first word
"""
import json
import torch
...
def main():
    ...
    fatiha_segments = sorted(glob.glob(os.path.join(datasets_dir, "001", "001-*.wav")))
    ...
    print("Training on: Al-Fatiha first second → first word")
