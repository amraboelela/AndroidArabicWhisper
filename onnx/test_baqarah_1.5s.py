...
def main():
  ...
  # Test on all 1.5-second chunks
  fps = 20
  chunk_duration = 1.5
  frames_per_chunk = int(fps * chunk_duration)  # 1.5 seconds = 30 frames
